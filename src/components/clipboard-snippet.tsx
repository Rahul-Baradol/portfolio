    ...
    return (
        <div className="relative w-full">
            <motion.code
                ...
                className="bg-black/5 dark:bg-black/30 backdrop-blur p-4 rounded-lg font-mono text-sm text-foreground border border-border shadow-sm flex flex-col gap-2 sm:flex-row justify-between items-end sm:items-center"
            >
